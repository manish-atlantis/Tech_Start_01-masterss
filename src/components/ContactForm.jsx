...
const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_woj0ubc', 'template_nt9lksk', form.current, {
        publicKey: 'CMKpsSU4ycQCPoczi',
      })
      .then(
        () => {
          setIsLoading(false);
      ...
      <div className="w-full max-w-screen-xl grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 border border-gray-300 rounded-lg shadow-lg flex flex-col items-start space-y-6">
          ...
          <div>
            ...
            <p class="mt-3 text-gray-500 dark:text-gray-400">Our friendly team is always here to help you.</p>
        </div>
          {/* Email */}
